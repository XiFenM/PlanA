...
### 当前状态背景
每个人的学习经历和背景是不同的。在此会阐明我个人关于本次学习主题上的既有知识与能力背景。
在此假设读者的知识水平起点大致是大学本科一年级新生，起码对微积分和C/C++编程领域的基本知识清楚了解，但不要求掌握特定的技巧。
我会在后续学习过程中尽可能地详细讲述，甚至补充一些我认为可能对理解有帮助的背景。读者如果遇到认为叙述依旧过于简略或者理解不清的部分，可以参考我的背景补充学习相应的知识。
...
5. 反直觉点；
6. 尚未理解的问题。
其中第1和第2大点在每个主题里应该都会存在，但其他部分不是一定会有。而且，为确保学习过程的流畅自然，在每一个主题中，我不再会严格区分以上多个小点的内容，而是会将它们融合在一起进行叙述。你可能会看到在同一段话中，既有原文转述，也有我的思考理解，还有可能的图示和源码锚点等等内容。
