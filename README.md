...
- **当前冲刺层**：以推理为主、训练系统素养为辅，按八个有效周和证据关卡推进，详见[当前活动计划](计划/高级AI框架开发工程师-八周证据冲刺计划.md)。[20 周主计划](计划/主计划.md)保留为冻结的长期候选排程，不裁决当前活动状态。
...
│   ├── 高级AI框架开发工程师-八周证据冲刺计划.md ← 当前活动的八周证据冲刺
...
│       └── AMD-AI框架开发工程师胜任力诊断-2026-08-29.md
│
├── Job Description/                ← 目标岗位 JD 集合，按方向分类
│   ├── AI框架方向/                 ← 历史 JD + 市场岗位需求分类索引
...
| [计划/高级AI框架开发工程师-八周证据冲刺计划.md](计划/高级AI框架开发工程师-八周证据冲刺计划.md) | 当前活动 Program、八个有效周、证据关卡与条件机动 | 阶段复盘或目标岗位变化时 |
